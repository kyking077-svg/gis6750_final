...
Our 3 datasets:
- Point data of fairy barrows, to determine if there is clustering in particular habitats
- Point data of stone circles, to see if THOSE are in any particular habitat (because they're bridges between worlds, so need to be in similar places)
- Shapefile from natural earth data of ireland, at highest resolution
- Raster data of land cover from 1990, to identify the habitats (and create the polygons to test for clustering)
- Raster data of land cover from 2018, to determine if fairy habitat has shrunk significantly
...
Get the stone circles point data into an sf object, combine with barrows and give both a new 'type' field
